...
export function Modal({showModal, setShowModal, notebook}: props) {
  ...
  if (!showModal)
    return (
      <div className="myModal flex items-center justify-center bg-neutral-500 bg-opacity-50 p-10 backdrop-blur-sm">
        <div className="flex h-full max-h-[1000px] min-h-min w-full max-w-[1500px] flex-col gap-10 rounded bg-white p-5">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex gap-5">
              ...
              <img src={'https://notebooksbucket.s3.us-east-2.amazonaws.com/' + arrayURL[viewIndex]} className="h-min w-32 rounded" alt="a" />
            ...
            <div id="teste">
              <span>oi</span>
              <img
                src={'https://notebooksbucket.s3.us-east-2.amazonaws.com/sC0Tz3o5O6UagfLfokVbHr0T7JL2/170974663sssssssssss1868.jpg'}
