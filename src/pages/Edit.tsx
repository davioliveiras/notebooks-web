...
export default function Edit(){
  ...
  const { noteboo } = useContext(EditContext)
  console.log(noteboo)
  ...
  const [ code, setCode ] = useState<string>(noteboo.code)
  console.log(code)
    ...
    <form onSubmit={submit} className="flex justify-center">
      <div className="flex bg-white pl-5 pr-5 gap-36 rounded shadow">
        <div className="flex flex-col pt-5">
          ...
          <input type="number" id="code" placeholder="123" onChange={event => {setCode(event.target.value)}}
